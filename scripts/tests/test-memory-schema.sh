...
assert_file_contains "$STRAT" "-8%"                            "strategy encodes -8% cut"
assert_file_contains "$STRAT" "14%"                            "strategy encodes 14% tighten threshold"
assert_file_contains "$STRAT" "18%"                            "strategy encodes 18% tighten threshold"
