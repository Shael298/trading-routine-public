---
description: Manual EOW-summary preview — read the log, compute metrics, draft a grade. Does not commit or push.
...
7. Draft a markdown block matching `WEEKLY-REVIEW.md` § entry template and show it to the operator. **Do not** write it to the file — the Friday EOW-summary routine owns that. This is a preview only.
